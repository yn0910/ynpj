  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: '3.2mm', letterSpacing: '4px', marginBottom: '4mm', fontWeight: 500 }}>
          WORK INSPECTION REPORT
        </p>
        <h1 style={{ color: '#ffffff', fontSize: '16mm', fontWeight: 700, letterSpacing: '3mm', margin: 0, lineHeight: 1 }}>
          作業報告書
        </h1>
      </div>
      ...
      >
        ...
        >
          {coverPhoto ? (
            ...
            <img src={coverPhoto.dataUrl} alt="表紙写真" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
          ) : (
        ...
        {/* 基本情報テーブル */}
        <div>
          <div style={{ width: '20mm', height: '1.2mm', background: '#1d4ed8', marginBottom: '5mm' }} />
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <tbody>
              {infoRows.map(({ label, value }) => (
                <tr key={label} style={{ borderBottom: '0.3mm solid #e5e7eb' }}>
                  <td style={{ padding: '5mm 4mm', width: '28%', backgroundColor: '#f0f4ff', fontSize: '3.8mm', color: '#1d4ed8', fontWeight: 700, verticalAlign: 'middle', whiteSpace: 'nowrap' }}>
                    {label}
                  </td>
                  <td style={{ padding: '5mm 6mm', fontSize: '4.5mm', color: '#111827', verticalAlign: 'middle', wordBreak: 'break-all' }}>
                    {value}
                  </td>
                </tr>
              ))}
